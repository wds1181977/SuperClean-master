...
import com.mobilefox.superclean.model.AppInfo;
import com.mobilefox.superclean.utils.StorageUtil;
import com.mobilefox.superclean.views.RippleView;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item != null) {
        	if(	item.isUserApp()){
        		...
        		holder.ripleUninstall.setVisibility(View.VISIBLE);
        	}else{
        		
        		holder.ripleUninstall.setVisibility(View.INVISIBLE);
        	}
